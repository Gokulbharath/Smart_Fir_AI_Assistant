...
const NewFIR: React.FC = () => {
  ...
  const updateWitness = (index: number, value: string) => {
    setIncident(prev => ({
      ...prev,
      witnesses: prev.witnesses.map((witness, i) => i === index ? value : witness)
    }));
  };
    ...
    <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 p-8">
      ...
      <div className="space-y-4">
        {ipcSections.map((section, index) => (
          <div key={index} className="border border-slate-200 dark:border-slate-600 rounded-xl p-5 hover:shadow-lg transition-all duration-200">
  ...
  const renderCurrentStep = () => {
    switch (currentStep) {
      case 1: return renderVictimForm();
      case 2: return renderAccusedForm();
      case 3: return renderIncidentForm();
      case 4: return renderIPCSections();
      default: return renderVictimForm();
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-400 dark:to-emerald-400 bg-clip-text text-transparent">Create New FIR</h1>
      ...
      <div className="flex justify-between">
        ...
        <div className="flex space-x-4">
          <button className="flex items-center space-x-2 px-6 py-3 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl font-semibold hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors">
          ...
          {currentStep < 4 ? (
            ...
            <button className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl">
